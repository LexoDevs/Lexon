...
void VulkanDescriptorPool::createDescriptorPool(VkDevice device,uint32_t materialCount)
{

    std::cout << "\033[1;36m[!] Creando Descriptor Pool...\033[0m\n";

    cp_device = device;
    const uint32_t descriptorCount = MAX_FRAMES_IN_FLIGHT * materialCount;
